...
<link href="https://fonts.googleapis.com/css?family=Kodchasan" rel="stylesheet">
    ...
    <body>
        ...
        include 'navBar.php';
         ?>
        <style>
body{background:url("https://previews.123rf.com/images/9dreamstudio/9dreamstudio1803/9dreamstudio180302297/97661036-courier-workplace-with-cardboard-box-for-delivery-on-stone-background-top-view-mockup.jpg"); background-size: cover}
h1 {
  font-size:3em; 
  font-weight: 300;
  line-height:1em;
